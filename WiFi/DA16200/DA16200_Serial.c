...
#define SERIAL_TXBUF_SZ   2048+32    /* MAX DATA (512)+ Header (32 )   header length check it again */
#endif

#ifndef SERIAL_RXBUF_SZ
#define SERIAL_RXBUF_SZ   2048
#endif
...
#define CMSIS_USART_DRIVER        CREATE_SYMBOL(Driver_USART, WIFI_DA16200_SERIAL_DRIVER)
...
uint32_t Serial_GetTxFree (void) {
  ...
  if (Com.txb != 0U) {
    ...
    n = SERIAL_TXBUF_SZ - 32;   /* Header size 32 */
  }
