...
/* ESP parser thread priority and stack size */
...
/* ESP parser buffer memory pool: (size of one block * total number of block) */
#define ESP_BUFFER_BLOCK_SIZE         WIFI_ESP8266_PARSER_BLOCK_SIZE
#define ESP_BUFFER_BLOCK_COUNT        WIFI_ESP8266_PARSER_BLOCK_COUNT
...
extern const osMemoryPoolAttr_t ESP_MemPool_Attr;
