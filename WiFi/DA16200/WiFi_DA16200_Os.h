...
#ifndef WIFI_DA16200_OS_H__
#define WIFI_DA16200_OS_H__
...
#define WIFI_THREAD_PRIORITY          CMSIS_RTOS2_PRIORITY(WIFI_DA16200_THREAD_PRIORITY)
#define WIFI_THREAD_STACK_SIZE        WIFI_DA16200_THREAD_STACK_SIZE

/* Socket buffer memory pool: (size of one block * total number of block) */
#define SOCKET_BUFFER_BLOCK_SIZE      WIFI_DA16200_SOCKET_BLOCK_SIZE
#define SOCKET_BUFFER_BLOCK_COUNT     WIFI_DA16200_SOCKET_BLOCK_COUNT

/* Serial parser buffer memory pool: (size of one block * total number of block) */
#define PARSER_BUFFER_BLOCK_SIZE      WIFI_DA16200_PARSER_BLOCK_SIZE
#define PARSER_BUFFER_BLOCK_COUNT     WIFI_DA16200_PARSER_BLOCK_COUNT
