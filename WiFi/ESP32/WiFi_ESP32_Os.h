...
#ifndef WIFI_ESP32_OS_H__
#define WIFI_ESP32_OS_H__
...
#define WIFI_THREAD_PRIORITY          CMSIS_RTOS2_PRIORITY(WIFI_ESP32_THREAD_PRIORITY)
#define WIFI_THREAD_STACK_SIZE        WIFI_ESP32_THREAD_STACK_SIZE

/* Socket buffer memory pool: (size of one block * total number of block) */
#define SOCKET_BUFFER_BLOCK_SIZE      WIFI_ESP32_SOCKET_BLOCK_SIZE
#define SOCKET_BUFFER_BLOCK_COUNT     WIFI_ESP32_SOCKET_BLOCK_COUNT

/* Serial parser buffer memory pool: (size of one block * total number of block) */
#define PARSER_BUFFER_BLOCK_SIZE      WIFI_ESP32_PARSER_BLOCK_SIZE
#define PARSER_BUFFER_BLOCK_COUNT     WIFI_ESP32_PARSER_BLOCK_COUNT
